...
Windows.click(findWindowsObject('ToolBar_MenuItems/Transactions'))
...
texter = Windows.getText(findWindowsObject('Transactions/GetText_Description'))

KeywordUtil.logInfo(texter)

if (txt1.equals(code) && txt2.contains(amount)&& texter.equals(description)) {
    KeywordUtil.markPassed('Account Number is valid')
} else {
    KeywordUtil.markFailed('Account Number is not valid')
}
